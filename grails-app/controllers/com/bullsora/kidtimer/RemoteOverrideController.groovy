...
class RemoteOverrideController {
  ...
  def index(Integer max) {
    ...
    respond RemoteOverride.list(params),
            model: [remoteOverrideInstanceCount: RemoteOverride.count()]
  }
  ...
  @Transactional
  def saveFromParams() {
    RemoteOverride remoteOverrideInstance = new RemoteOverride(params).save( flush: true)
    ...
    request.withFormat {
      form multipartForm {
        flash.message = message(code: 'default.created.message', args: [
            message(code: 'remoteOverride.label',
                    default: 'RemoteOverride'), remoteOverrideInstance.id])
        redirect remoteOverrideInstance
      }
    ...
    request.withFormat {
      form multipartForm {
        flash.message = message(code: 'default.not.found.message', args: [
            message(code: 'remoteOverride.label', default: 'RemoteOverride'), params.id])
        redirect action: "index", method: "GET"
      }
